...
if (nrow(PA_Report_sms_rem) > 50) {
  ...
  write.csv(PA_Report_sms_rem,glue("{local_drive}Multiple_PA_Report_sms_text_rem_reminders_{currentDate}_boxfolder_{boxfolder}.csv"),row.names = F,na="")
} else {
...
if (nrow(Dup_Report_sms_rem) > 50) {
  ...
  write.csv(Dup_Report_sms_rem,glue("{local_drive}Multiple_Dup_Report_sms_text_rem_reminders_{currentDate}_boxfolder_{boxfolder}.csv"),row.names = F,na="")
} else {
...
if (nrow(DHQ_sms_rem) > 50) {
  ...
  write.csv(DHQ_sms_rem,glue("{local_drive}Multiple_DHQ_sms_text_rem_reminders_{currentDate}_boxfolder_{boxfolder}.csv"),row.names = F,na="")
} else {
...
if (nrow(DHQ_Report_sms_rem) > 50) {
  ...
  write.csv(DHQ_Report_sms_rem,glue("{local_drive}Multiple_DHQ_Report_sms_text_rem_reminders_{currentDate}_boxfolder_{boxfolder}.csv"),row.names = F,na="")
} else {
