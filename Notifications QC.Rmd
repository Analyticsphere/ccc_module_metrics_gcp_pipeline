...
DDR_email <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
DDR_SMS <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
HIPAA_email <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
HIPAA_sms <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
HPBB_email <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
HPBB_sms <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
BSWHBB_email <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
BSWHBB_sms <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
UCBB_email <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
UCBB_sms <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
KPBio_Email <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
KPBio_SMS <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
HF_Srvy_Bio_email <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
HF_Srvy_Bio_sms <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
WD_email <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
WD_sms <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
...
PROMIS_TY <- "SELECT distinct(p.Connect_ID), #distinct(n.token), 
category,
       DATE(notification_time) as repeat_date, 
       COUNT(*) as num_same_day_attempts
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` n
