...
## 95.	If verified, update recruit type should be sent. This rule allows for a lag of 5 days post-verification.
...
```{r ROI_Pref, echo=FALSE, warning=FALSE, message=FALSE, include=FALSE}

#When survey becomes available in BQ


#\FloatBarrier
## 96. If the ROI Pref Survey Status flag is null, there should be no survey data.
...
Connect_ID in (select Connect_ID from `nih-nci-dceg-connect-prod-6d04.FlatConnect.preference2025` )
order by Site"
