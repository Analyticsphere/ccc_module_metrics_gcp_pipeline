...
#   filter(lower(AB_response) != lower(UTM_camp))
# 
# 
# if (nrow(AB1) == 0) {
#   cat("No errors\n")
# } else {
#   
#   AB1 <- AB1 %>% select(Site, Connect_ID, AB_response, UTM_camp) %>%  safe_arrange(Site)
# 
#   knitr::kable(AB1) %>%
#     kable_styling(latex_options = "scale_down")
# }
...
# } else {
#   
#   AB2 <- AB2 %>% select(Site, Connect_ID, d_821247024, state_d_793822265) %>%  safe_arrange(Site)
# 
#   colnames(AB2) <- c("Site", "Connect ID", 'RcrtV_Verification', "RcrtV_UpdateRecType")
# 
#   knitr::kable(AB2) %>%
#     kable_styling(latex_options = "scale_down")
# }
