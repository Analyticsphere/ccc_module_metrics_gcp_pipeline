...
## 61. If RcrtV_Verification_v1r0 is 'Verified' and RcrtSI_RecruitType_v1r0 is 'Active or 'Passive', then Automated verification, should be 'Method not used' or 'Method used'. Participants must be verified for at least 5 days.
...
if (nrow(auto_ver) == 0) {
  ...
  auto_ver <- auto_ver %>% select(Site, Connect_ID, d_512820379, d_914594314, state_d_444699761) %>%  safe_arrange(Site)
  
  colnames(auto_ver) <- c("Site", "Connect ID", 'RcrtSI_RecruitType_v1r0', "RcrtV_VerificationTm_V1R0", "Automated verification")
...
## 62. If RcrtV_Verification_v1r0 is 'Verified' and RcrtSI_RecruitType_v1r0 is 'Active or 'Passive', then Outreach required for Verification, should be 'Yes', or 'No'. Participants must be verified for at least 5 days.
...
## 63. If RcrtV_Verification_v1r0 is 'Verified' and RcrtSI_RecruitType_v1r0 is 'Active or 'Passive', then Manual verification should be 'Method not used' or 'Method used'. Participants must be verified for at least 5 days.
```{r manual_ver, echo=FALSE, warning=FALSE, message=FALSE}

manual_ver <- partsbq	%>% filter(d_821247024=='197316935' & 
...
if (nrow(manual_ver) == 0) {
  ...
  manual_ver <- manual_ver %>% select(Site, Connect_ID, d_512820379, d_914594314, state_d_953614051) %>%  safe_arrange(Site)
  
  colnames(manual_ver) <- c("Site", "Connect ID", 'RcrtSI_RecruitType_v1r0', "RcrtV_VerificationTm_V1R0", "Manual verification")
...
## 68. If RcrtV_Verification_v1r0 is 'Verified' and RcrtSI_RecruitType_v1r0 is 'Active or 'Passive', then PIN Match, should be 'Not Matched' or 'Matched'. Participants must be verified for at least 5 days.
...
## 69. If RcrtV_Verification_v1r0 is 'Verified' and RcrtSI_RecruitType_v1r0 is 'Active or 'Passive', then Token Match, should be 'Not Matched' or 'Matched'. Participants must be verified for at least 5 days.
