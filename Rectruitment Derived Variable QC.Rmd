...
if (nrow(reinvite_date_type) < 50) {
  ...
  cat(paste0(
    ...
    "Recruitment_QC_Rule46_Errors", currentDate, "_boxfolder_", boxfolder, ".xlsx' \n"
  ))
...
if (nrow(reinv_active) < 50) {
  ...
  cat(paste0(
    "There are ", nrow(reinv_active1), " rows. This has been made into a separate XLXS file called\n",
    "'Biospecimen_QC_Rule60_Errors", currentDate, "_boxfolder_", boxfolder, ".xlsx'\n"
  ))
...
## 68. If RcrtV_Verification_v1r0 is 'Verified' and RcrtSI_RecruitType_v1r0 is 'Active or 'Passive', then PIN Match, should be 'Not Matched', 'Matched', or NULL. Participants must be verified for at least 5 days.
...
if (nrow(pin_match) == 0) {
  ...
  pin_match <- pin_match %>% select(Site, Connect_ID, d_512820379, d_914594314, state_d_557461333) %>%  safe_arrange(Site)
...
## 69. If RcrtV_Verification_v1r0 is 'Verified' and RcrtSI_RecruitType_v1r0 is 'Active or 'Passive', then Token Match, should be 'Not Matched', 'Matched', or NULL. Participants must be verified for at least 5 days.
...
## 70. If RcrtV_Verification_v1r0 is 'Verified' and RcrtSI_RecruitType_v1r0 is 'Active or 'Passive', then ZIP Code Match, should be 'Not Matched', 'Matched', or NULL. Participants must be verified for at least 5 days.
...
if (nrow(act_di_SF_race) < 50) {
  ...
  cat(paste0(
    "There are ", nrow(act_di_SF_race), " rows. This has been made into a separate XLXS file called \n",
    "Recruitment_Derived_QC_Rule76_Errors", currentDate, "_boxfolder_", boxfolder, ".xlsx' \n"
  ))
...
if (nrow(AB2) < 50) {
  ...
  cat(paste0(
    "There are ", nrow(AB2), " rows. This has been made into a separate XLXS file called \n",
    "Recruitment_Derived_QC_Rule88_Errors", currentDate, "_boxfolder_", boxfolder, ".xlsx' \n"
  ))
...
if (nrow(Non_act_verif) < 50) {
  ...
  cat(paste0(
    "There are ", nrow(Non_act_verif), " rows. This has been made into a separate XLXS file called \n",
    "Recruitment_Derived_QC_Rule95_Errors", currentDate, "_boxfolder_", boxfolder, ".xlsx' \n"
  ))
