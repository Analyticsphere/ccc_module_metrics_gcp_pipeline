...
if (nrow(mens_elg) == 0) {
  ...
  mens_elg <- mens_elg %>%  select(Site, Connect_ID, d_289750687)  %>%  sort_by(Site) 
...
if (nrow(cash_NORC) == 0) {
  ...
  cash_NORC <- cash_NORC %>%  select(Site, Connect_ID, d_130371375_d_266600170_d_945795905, d_130371375_d_266600170_d_320023644) %>%  sort_by(Site)
...
if (nrow(bday) == 0) {
  ...
  bday <- bday %>% select(Site, Connect_ID, d_371067537, d_544150384, d_564964481, d_795827569) %>%  sort_by(Site)
...
smmet0 <- partsbq %>%  filter(d_685002411_d_994064239==104430631 & d_685002411_d_194410742==104430631 & d_685002411_d_949501163==104430631 & 
                                ...
                                d_831041022==104430631 & d_987563196==104430631 & d_912301837!=208325815) %>% 
...
if (nrow(smmet2) == 0) {
  ...
  smmet2 <- smmet2 %>%  select(Site, Connect_ID, d_912301837) %>% sort_by(Site)
...
if (nrow(smmet3) == 0) {
  ...
  smmet3 <- smmet3 %>%  select(Site, Connect_ID, d_912301837) %>%  sort_by(Site)
...
if (nrow(smmet4) == 0) {
  ...
  smmet4 <- smmet4 %>% select(Site, Connect_ID, d_912301837) %>%  sort_by(Site)
...
if (nrow(opt_out) == 0) {
  ...
  opt_out <- opt_out %>% select(Site, Connect_ID, state_d_158291096) %>%  sort_by(Site)
...
if (nrow(pref_lang) == 0) {
  ...
  pref_lang <- pref_lang %>%  select(Site, Connect_ID, RcrtCS_PrefLang_v1r0, RcrtCS_ConsentSumit_v1r0) %>%  sort_by(Site)
...
if (nrow(comp_m1) == 0) {
  ...
  comp_m1 <- comp_m1 %>% select(Site, Connect_ID, d_517311251, d_949302066) %>%  sort_by(Site)
...
if (nrow(comp_m2) == 0) {
  ...
  comp_m2 <- comp_m2 %>%  select(Site, Connect_ID, d_832139544, d_536735468) %>%  sort_by(Site)
...
if (nrow(comp_m3) == 0) {
  ...
  comp_m3 <- comp_m3 %>% select(Site, Connect_ID, d_770257102, d_976570371) %>%  sort_by(Site)
...
if (nrow(comp_m4) == 0) {
  ...
  comp_m4 <- comp_m4 %>% select(Site, Connect_ID, d_264644252, d_663265240) %>%  sort_by(Site)
...
if (nrow(comp_qol) == 0) {
  ...
  comp_qol <- comp_qol %>%  select(Site, Connect_ID, d_843688458, d_320303124) %>%  sort_by(Site)
...
if (nrow(comp_ces) == 0) {
  ...
  comp_ces <- comp_ces %>%  select(Site, Connect_ID, d_199471989, d_956490759) %>%  sort_by(Site)
...
if (nrow(comp_bum) == 0) {
  ...
  comp_bum <- comp_bum %>%  select(Site, Connect_ID, d_222161762, d_265193023) %>%  sort_by(Site)
...
if (nrow(comp_bu) == 0) {
  ...
  comp_bu <- comp_bu %>% select(Site, Connect_ID, d_764863765, d_253883960) %>%  sort_by(Site)
...
if (nrow(comp_mw) == 0) {
  ...
  comp_mw <- comp_mw %>% select(Site, Connect_ID, d_195145666, d_547363263) %>%  sort_by(Site)
...
if (nrow(comp_cv) == 0) {
  ...
  comp_cv <- comp_cv %>%  select(Site, Connect_ID, d_784810139, d_220186468) %>%  sort_by(Site)
...
if (nrow(comp_mns) == 0) {
  ...
  comp_mns <- comp_mns %>%select(Site, Connect_ID, d_217640691, d_459098666) %>%  sort_by(Site)
...
if (nrow(comp_ssn) == 0) {
  ...
  comp_ssn <- comp_ssn %>% select(Site, Connect_ID, d_315032037, d_126331570) %>%  sort_by(Site)
...
if (nrow(comp_csh) == 0) {
  ...
  comp_csh <- comp_csh %>% select(Site, Connect_ID, d_389890053, d_176068627) %>%  sort_by(Site)
...
if (nrow(start_m1) == 0) {
  ...
  start_m1 <- start_m1 %>% select(Site, Connect_ID, d_205553981, d_949302066) %>%  sort_by(Site)
...
if (nrow(start_m2) == 0) {
  ...
  start_m2 <- start_m2 %>% select(Site, Connect_ID, d_541836531, d_536735468) %>%  sort_by(Site)
...
if (nrow(start_m3) == 0) {
  ...
  start_m3 <- start_m2 %>% select(Site, Connect_ID, d_386488297, d_976570371) %>%  sort_by(Site)
...
if (nrow(start_m4) == 0) {
  ...
  start_m4 <- start_m4 %>% select(Site, Connect_ID, d_452942800, d_663265240) %>%  sort_by(Site)
...
if (nrow(start_qol) == 0) {
  ...
  start_qol <- start_qol %>% select(Site, Connect_ID, d_870643066, d_320303124) %>%  sort_by(Site)
...
if (nrow(start_ces) == 0) {
  ...
  start_ces <- start_ces %>% select(Site, Connect_ID, d_263355177, d_956490759) %>%  sort_by(Site)
...
if (nrow(start_bum) == 0) {
  ...
  start_bum <- start_bum %>% select(Site, Connect_ID, d_822499427, d_265193023) %>%  sort_by(Site)
...
if (nrow(start_bu) == 0) {
  ...
  start_bu <- start_bu %>% select(Site, Connect_ID, d_534669573, d_253883960) %>%  sort_by(Site)
...
if (nrow(start_mw) == 0) {
  ...
  start_mw <- start_mw %>% select(Site, Connect_ID, d_286191859, d_547363263) %>%  sort_by(Site)
...
if (nrow(start_cv) == 0) {
  ...
  start_cv <- start_cv %>% select(Site, Connect_ID, d_268176409, d_220186468) %>%  sort_by(Site)
...
if (nrow(start_mns) == 0) {
  ...
  start_mns <- start_mns %>% select(Site, Connect_ID, d_844088537, d_459098666) %>%  sort_by(Site)
...
if (nrow(start_ssn) == 0) {
  ...
  start_ssn <- start_ssn %>% select(Site, Connect_ID, d_943232079, d_126331570) %>%  sort_by(Site)
...
if (nrow(start_csh) == 0) {
  ...
  start_csh <- start_csh %>% select(Site, Connect_ID, d_609630315, d_176068627) %>%  sort_by(Site)
...
<!-- reinvite_date_type <- base_vars %>%  filter(!is.na(d_439351436) & is.na(d_280021666)) -->
...
<!--   reinvite_date_type <- reinvite_date_type  %>% select(Site, Connect_ID, d_439351436, d_280021666)  %>%  sort_by(Site) -->
<!--   colnames(reinvite_date_type) <- c("Site", "Connect ID", "RcrtSI_RInvTimeStamp_v1r0", "RcrtSI_RInvCampaignType_v1r0") -->

<!--   knitr::kable(reinvite_date_type) %>% -->
<!--     kable_styling(latex_options = "scale_down") -->
<!-- } -->
...
<!--   reinvite_start <- reinvite_start  %>% select(Site, Connect_ID, d_439351436, d_280021666)  %>%  sort_by(Site) -->
