...
### Logic:
# Never a smoker: Ever Smoking = NO OR (Ever Smoking = YES AND # of CIGS [CIG1] <50)
# Current smoker: Ever Smoking = YES AND # of CIGS [CIG1] >49 AND Smoked in the last month [CIG5] 
# Former Smoker: Ever Smoking = YES AND  # of CIGS [CIG1] >49 AND Smoked more than a month ago [CIG5]
# Skipped : Doesnt fall into the other categories
...
cig_frequency= data_tib_all3  %>% 
  mutate(often= case_when((D_947205597_D_712653855==0 | 
                             (D_947205597_D_712653855==1 & (D_763164658==151488193| D_763164658==805449318)))~"Never a Cigarette Smoker",
                             (D_947205597_D_712653855==1 & 
                                (D_763164658==486319890| D_763164658==132232896) & 
                                D_798549704==317567178)~"Currently a Cigarette Smoker",
                             (D_947205597_D_712653855==1 & 
                                (D_763164658==486319890| D_763164658==132232896)  & 
                                (D_798549704==484055234 | D_798549704==802197176))~"Formerly a Cigarette Smoker",
