...
test_promis <- "SELECT *
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.promis_v1_JP`
...
parts <- "SELECT Connect_ID, d_311580100, d_371067537, d_870643066, d_843688458
 FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.participants_JP` where Connect_ID IS NOT NULL and 
