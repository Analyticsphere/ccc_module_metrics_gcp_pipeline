...
LEAST(COALESCE(d_173836415_d_266600170_d_769615780, d_173836415_d_266600170_d_939818935), COALESCE(d_173836415_d_266600170_d_939818935, d_173836415_d_266600170_d_769615780))   as first_draw_order, 
 d_173836415_d_266600170_d_156605577,
 LEAST(COALESCE(d_173836415_d_266600170_d_982213346, d_173836415_d_266600170_d_139245758), COALESCE(d_173836415_d_266600170_d_139245758, d_173836415_d_266600170_d_982213346))  as first_collection,
FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.participants` parts
left join `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` notif
on notif.token=parts.token and
category LIKE 'KP%' and category LIKE '%baseline biospecimen invitations%' 
where Connect_ID NOT IN ('1766922128', '3613468175', '3698144899', '8417684909' ) and
...
# FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.participants` parts
# inner join `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` notif
# on notif.token=parts.token and
...
# count(*) reminders_sent FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` 
...
# SELECT count(distinct(token)) FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications` 
# where category LIKE 'KP%' and category LIKE '%baseline biospecimen invitations%'
...
KPR <- KPR %>%  mutate(Site=case_when(d_827220437==125001209 ~ "Kaiser Permanente Colorado",
                       ...
                       sample_given = case_when(d_173836415_d_266600170_d_156605577=="353358909" ~ "Blood or Urine Sample Received",
                                   d_173836415_d_266600170_d_156605577=="104430631"  ~ "No Sample Received"),
...
tab_footnote(
  footnote=("The participants included in this report are verified and have had a baseline blood or urine draw order placed between 4/1/2023 and 12/1/2023."),
...
comp__time <- updated_KPR %>%
  ...
  mutate(time_frame = case_when(
    ...
    TRUE ~ "Gave sample after Biospecimen Contact 5"
  )) 
...
None_List <- c("No sample Given after Biospecimen Contact 5")
None_Numb <- c(as.numeric(table(updated_KPR$d_173836415_d_266600170_d_156605577[!duplicated(updated_KPR$Connect_ID)])[1]))


None_rows <- data.frame(Column1 = None_List, Column2 = None_Numb)
colnames(None_rows) <- c("All Reminders", "n")




final_notif_emails <- bind_rows(final_notif_emails, None_rows)
...
final_notif_emails_gt %>% gt(rowname_col = "row_lab") %>%
  cols_label("All Reminders"= md(" "), n = md("**n**"), "%" = md("**%**")) %>% 
   tab_header(title = md("Table 2. KP Biospecimen Email Reminders Evaluation, All KP Sites")) %>%
  tab_style(
    style = list(
...
tab_footnote(
 ...
 tab_footnote(
  footnote=("
'Eligible for reminder' is calculated as those sent the previous reminder minus those who completed the specimen donation after the previous reminder."),
  locations = cells_column_labels(columns = "All Reminders")
) %>% 
 tab_footnote(
  footnote=("
...
updated_KPR_CO  <- updated_KPR %>% filter(d_827220437=='125001209')
...
KPR_ct <- updated_KPR_CO %>% mutate(cnt_number=case_when(attempt=="1st contact" ~ "Sent contact 1",
                                                          attempt=="2nd contact" ~ "Sent contact 2",
                                                          attempt=="3rd contact" ~ "Sent contact 3",
                                                          attempt=="4th contact" ~ "Sent contact 4",
                                                          attempt=="5th contact" ~ "Sent contact 5"))
...
#Sent previous contact - people who finished
EligibleList <- c("Eligible for BiospecimenContact 2","Eligible for BiospecimenContact 3", "Eligible for BiospecimenContact 4", "Eligible for BiospecimenContact 5")
EligibleNumb <- c(length(unique(updated_KPR_CO$Connect_ID)) - (sum(comp_time[1,2]) + sum(comp_time[2,2])), #eligible2= all participants-those who completed before contact 2
                  Sent_rows[2,2] - sum(comp_time[3,2]) , #eligible for 3= sent contact 2- completed before contact 3
                  Sent_rows[3,2] - sum(comp_time[4,2]), #eligible for 4= sent contact3-completed before contact 4
                  Sent_rows[4,2] - sum(comp_time[5,2])) #eligible for 5= sent contact4- completed before contact 5
...
None_List <- c("No sample Given after Biospecimen Contact 5")
None_Numb <- c(as.numeric(table(updated_KPR_CO$d_173836415_d_266600170_d_156605577[!duplicated(updated_KPR_CO$Connect_ID)])[1]))
...
final_notif_emails$'%' <- c(paste(100*round(final_notif_emails[1,2]/length(unique(updated_KPR_CO$Connect_ID)), digits=4), "%"),
                            paste(100*round(final_notif_emails[2,2]/length(unique(updated_KPR_CO$Connect_ID)), digits=3), "%"), 
                            paste(100*round(final_notif_emails[3,2]/length(unique(updated_KPR_CO$Connect_ID)), digits=3), "%"), 
                            paste(100*round(final_notif_emails[4,2]/length(unique(updated_KPR_CO$Connect_ID)), digits=3), "%"), 
                            paste(100*round(final_notif_emails[5,2]/final_notif_emails[4,2], digits=3), "%"), 
                            paste(100*round(final_notif_emails[6,2]/final_notif_emails[5,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[7,2]/final_notif_emails[5,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[8,2]/final_notif_emails[7,2], digits=3), "%"),
...
final_notif_emails_gt %>% gt(rowname_col = "row_lab") %>%
  cols_label("All Reminders"= md(" "), n = md("**n**"), "%" = md("**%**")) %>% 
   tab_header(title = md("Table 2.1 KPCO Biospecimen Email Reminders Evaluation")) %>%
  tab_style(
    style = list(
      cell_text(weight = "bold")
    ),
...
updated_KPR_NW  <- updated_KPR %>% filter(d_827220437=='452412599')
...
KPR_ct <- updated_KPR_NW %>% mutate(cnt_number=case_when(attempt=="1st contact" ~ "Sent contact 1",
                                                          attempt=="2nd contact" ~ "Sent contact 2",
                                                          attempt=="3rd contact" ~ "Sent contact 3",
                                                          attempt=="4th contact" ~ "Sent contact 4",
                                                          attempt=="5th contact" ~ "Sent contact 5"))
...
#Sent previous contact - people who finished
EligibleList <- c("Eligible for BiospecimenContact 2","Eligible for BiospecimenContact 3", "Eligible for BiospecimenContact 4", "Eligible for BiospecimenContact 5")
EligibleNumb <- c(length(unique(updated_KPR_NW$Connect_ID))- (sum(comp_time[1,2]) + sum(comp_time[2,2])), #eligible2= all participants-those who completed before contact 2
                  Sent_rows[2,2] - sum(comp_time[3,2]) , #eligible for 3= sent contact 2- completed before contact 3
                  Sent_rows[3,2] - sum(comp_time[4,2]), #eligible for 4= sent contact3-completed before contact 4
                  Sent_rows[4,2] - sum(comp_time[5,2])) #eligible for 5= sent contact4- completed before contact 5
...
None_List <- c("No sample Given after Biospecimen Contact 5")
None_Numb <- c(as.numeric(table(updated_KPR_NW$d_173836415_d_266600170_d_156605577[!duplicated(updated_KPR_NW$Connect_ID)])[1]) )
...
final_notif_emails$'%' <- c(paste(100*round(final_notif_emails[1,2]/length(unique(updated_KPR_NW$Connect_ID)), digits=4), "%"),
                            paste(100*round(final_notif_emails[2,2]/length(unique(updated_KPR_NW$Connect_ID)), digits=3), "%"), 
                            paste(100*round(final_notif_emails[3,2]/length(unique(updated_KPR_NW$Connect_ID)), digits=3), "%"), 
                            paste(100*round(final_notif_emails[4,2]/length(unique(updated_KPR_NW$Connect_ID)), digits=3), "%"), 
                            paste(100*round(final_notif_emails[5,2]/final_notif_emails[4,2], digits=3), "%"), 
                            paste(100*round(final_notif_emails[6,2]/final_notif_emails[5,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[7,2]/final_notif_emails[5,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[8,2]/final_notif_emails[7,2], digits=3), "%"),
...
final_notif_emails_gt %>% gt(rowname_col = "row_lab") %>%
  cols_label("All Reminders"= md(" "), n = md("**n**"), "%" = md("**%**")) %>% 
   tab_header(title = md("Table 2.2 KPNW Biospecimen Email Reminders Evaluation")) %>%
  tab_style(
    style = list(
      cell_text(weight = "bold")
    ),
...
updated_KPR_HI  <- updated_KPR %>% filter(d_827220437=='300267574')
...
KPR_ct <- updated_KPR_HI %>% mutate(cnt_number=case_when(attempt=="1st contact" ~ "Sent contact 1",
                                                          attempt=="2nd contact" ~ "Sent contact 2",
                                                          attempt=="3rd contact" ~ "Sent contact 3",
                                                          attempt=="4th contact" ~ "Sent contact 4",
                                                          attempt=="5th contact" ~ "Sent contact 5"))
...
#Sent previous contact - people who finished
EligibleList <- c("Eligible for BiospecimenContact 2","Eligible for BiospecimenContact 3", "Eligible for BiospecimenContact 4", "Eligible for BiospecimenContact 5")
EligibleNumb <- c(length(unique(updated_KPR_HI$Connect_ID))- (sum(comp_time[1,2]) + sum(comp_time[2,2])), #eligible2= all participants-those who completed before contact 2
                  Sent_rows[2,2] - sum(comp_time[3,2]) , #eligible for 3= sent contact 2- completed before contact 3
                  Sent_rows[3,2] - sum(comp_time[4,2]), #eligible for 4= sent contact3-completed before contact 4
                  Sent_rows[4,2] - sum(comp_time[5,2])) #eligible for 5= sent contact4- completed before contact 5
...
None_List <- c("No sample Given after Biospecimen Contact 5")
None_Numb <- c(as.numeric(table(updated_KPR_HI$d_173836415_d_266600170_d_156605577[!duplicated(updated_KPR_HI$Connect_ID)])[1]) )
...
final_notif_emails$'%' <- c(paste(100*round(final_notif_emails[1,2]/length(unique(updated_KPR_HI$Connect_ID)), digits=4), "%"),
                            paste(100*round(final_notif_emails[2,2]/length(unique(updated_KPR_HI$Connect_ID)), digits=3), "%"), 
                            paste(100*round(final_notif_emails[3,2]/length(unique(updated_KPR_HI$Connect_ID)), digits=3), "%"), 
                            paste(100*round(final_notif_emails[4,2]/length(unique(updated_KPR_HI$Connect_ID)), digits=3), "%"), 
                            paste(100*round(final_notif_emails[5,2]/final_notif_emails[4,2], digits=3), "%"), 
                            paste(100*round(final_notif_emails[6,2]/final_notif_emails[5,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[7,2]/final_notif_emails[5,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[8,2]/final_notif_emails[7,2], digits=3), "%"),
...
final_notif_emails_gt %>% gt(rowname_col = "row_lab") %>%
  cols_label("All Reminders"= md(" "), n = md("**n**"), "%" = md("**%**")) %>% 
   tab_header(title = md("Table 2.3 KPHI Biospecimen Email Reminders Evaluation")) %>%
  tab_style(
    style = list(
      cell_text(weight = "bold")
    ),
...
updated_KPR_GA  <- updated_KPR %>% filter(d_827220437=='327912200')
...
KPR_ct <- updated_KPR_GA %>% mutate(cnt_number=case_when(attempt=="1st contact" ~ "Sent contact 1",
                                                          attempt=="2nd contact" ~ "Sent contact 2",
                                                          attempt=="3rd contact" ~ "Sent contact 3",
                                                          attempt=="4th contact" ~ "Sent contact 4",
                                                          attempt=="5th contact" ~ "Sent contact 5"))
...
#Sent previous contact - people who finished
EligibleList <- c("Eligible for BiospecimenContact 2","Eligible for BiospecimenContact 3", "Eligible for BiospecimenContact 4", "Eligible for BiospecimenContact 5")
EligibleNumb <- c(length(unique(updated_KPR_GA$Connect_ID))-  sum(comp_time[2,2]), #eligible2= all participants-those who completed before contact 2
                  Sent_rows[2,2] - sum(comp_time[3,2]) , #eligible for 3= sent contact 2- completed before contact 3
                  Sent_rows[3,2] - sum(comp_time[4,2]), #eligible for 4= sent contact3-completed before contact 4
                  Sent_rows[4,2] - sum(comp_time[5,2])) #eligible for 5= sent contact4- completed before contact 5
...
#didn't have anyone before contact 1, have to remove

final_notif_emails <- bind_rows(comp_time, Sent_rows, Eligible_rows)
final_notif_emails <- final_notif_emails[c(7, 2, 12, 8, 3, 13, 9, 4, 14, 10, 5, 15, 11, 6), ]


None_List <- c("No sample Given after Biospecimen Contact 5")
None_Numb <- c(as.numeric(table(updated_KPR_GA$d_173836415_d_266600170_d_156605577[!duplicated(updated_KPR_GA$Connect_ID)])[1]))
...
final_notif_emails$'%' <- c(paste(100*round(final_notif_emails[1,2]/length(unique(updated_KPR_GA$Connect_ID)), digits=4), "%"), 
                            paste(100*round(final_notif_emails[2,2]/length(unique(updated_KPR_GA$Connect_ID)), digits=3), "%"), 
                            paste(100*round(final_notif_emails[3,2]/length(unique(updated_KPR_GA$Connect_ID)), digits=3), "%"), 
                            paste(100*round(final_notif_emails[4,2]/final_notif_emails[3,2], digits=3), "%"), 
                            paste(100*round(final_notif_emails[5,2]/final_notif_emails[4,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[6,2]/final_notif_emails[4,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[7,2]/final_notif_emails[6,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[8,2]/final_notif_emails[7,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[9,2]/final_notif_emails[7,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[10,2]/final_notif_emails[9,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[11,2]/final_notif_emails[10,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[12,2]/final_notif_emails[10,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[13,2]/final_notif_emails[12,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[14,2]/final_notif_emails[13,2], digits=3), "%"),
                            paste(100*round(final_notif_emails[15,2]/final_notif_emails[13,2], digits=3), "%"))
                            # paste(100*round(final_notif_emails[17,2]/final_notif_emails[16,2], digits=3), "%"),
                            # paste(100*round(final_notif_emails[18,2]/final_notif_emails[17,2], digits=3), "%")) #b12
...
# Specify the rows to be bolded
bold_rows <- c(1,3,4,6,7,9,10,12,13)
...
final_notif_emails_gt %>% gt(rowname_col = "row_lab") %>%
  cols_label("All Reminders"= md(" "), n = md("**n**"), "%" = md("**%**")) %>% 
   tab_header(title = md("Table 2.4 KPGA Biospecimen Email Reminders Evaluation")) %>%
  tab_style(
    style = list(
      cell_text(weight = "bold")
    ),
