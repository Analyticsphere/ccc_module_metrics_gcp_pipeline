...
# reformatting the above so I can run it in chunk - MH
...
rm(list = setdiff(ls(), c("data_tib_m1", 'module1', 'module1', "dict", 'hist_funct', 'boxp_funct', 'simple_funct', 'one_logic_funct', 'sib_logic_funct', 'child_logic_funct',
...
mhgroup1_long <- mhgroup1_flags %>%
  ...
  mutate(Condition = case_when(
    ...
    Condition == "Heart_Disease" ~ "Heart_Disease",
...
# adjusted these to display all three for comparison - you can replace with just the derived age variable if that's preferable

#cat("B-12 Deficiency (Pernicious Anemia) Diagnosis")
b12_ad_dg=boxp_funct(b12_derived_age,"B12 Deficiency Age at Diagnosis, Derived","Age" )
...
grid.arrange(b12_ad_dg,b12_a_dg, b12_y_dg, nrow=3)


#cat("Coronary Artery/Coronary Heart Disease Diagnosis")
chd_ad_dg=boxp_funct(chd_derived_age,"Heart Disease Age at Diagnosis, Derived","Age" )
chd_a_dg=boxp_funct(D_929240175_D_206625031,"Heart Disease Age at Diagnosis","Age" )
chd_y_dg=boxp_funct(D_929240175_D_261863326,"Heart Disease Year at Diagnosis","Year" )
grid.arrange(chd_ad_dg, chd_a_dg, chd_y_dg, nrow=3)


#cat("Congestive Heart Failure Diagnosis")
chf_ad_dg=boxp_funct(chf_derived_age,"Congestive Heart Failure Age at Diagnosis, Derived","Age" ) 
chf_a_dg=boxp_funct(D_836712013_D_206625031,"Congestive Heart Failure Age at Diagnosis","Age" ) 
chf_y_dg=boxp_funct(D_836712013_D_261863326,"Congestive Heart Failure Year at Diagnosis","Year" )
grid.arrange(chf_ad_dg, chf_a_dg, chf_y_dg, nrow=3)


#cat("High Cholesterol Diagnosis")
hc_ad_dg=boxp_funct(hc_derived_age,"High Cholesterol Age at Diagnosis, Derived","Age" )
...
grid.arrange(hc_ad_dg, hc_a_dg, hc_y_dg, nrow=3)


#cat("Heart Attack (Myocardial Infarction) Diagnosis")
hrt_ad_dg=boxp_funct(hrt_derived_age,"Heart Attack Age at Diagnosis, Derived","Age" )
...
grid.arrange(hrt_ad_dg, hrt_a_dg, hrt_y_dg, nrow=3)

#cat("Abnormal Heart Rhythm (Arrhythmia) Diagnosis")
ahr_ad_dg=boxp_funct(ahr_derived_age,"Abnormal Heart Rhythm Age at Diagnosis, Derived","Age" )
ahr_a_dg=boxp_funct(D_337278854_D_206625031,"Abnormal Heart Rhythm Age at Diagnosis","Age" )
ahr_y_dg=boxp_funct(D_337278854_D_261863326,"Abnormal Heart Rhythm Year at Diagnosis","Year" )
grid.arrange(ahr_ad_dg, ahr_a_dg, ahr_y_dg, nrow=3)


#cat("Chest Pain (Angina) Diagnosis")
cp_ad_dg=boxp_funct(cp_derived_age,"Chest Pain Age at Diagnosis, Derived","Age" )
...
grid.arrange(cp_ad_dg, cp_a_dg, cp_y_dg, nrow=3)


#cat("Heart Valve Problems Diagnosis")
hvp_ad_dg <- boxp_funct(hvp_derived_age, "Heart Valve Problems Age at Diagnosis, Derived", "Age")
hvp_a_dg  <- boxp_funct(D_660358706_D_206625031, "Heart Valve Problems Age at Diagnosis", "Age")
hvp_y_dg  <- boxp_funct(D_660358706_D_261863326, "Heart Valve Problems Year at Diagnosis", "Year")
grid.arrange(hvp_ad_dg, hvp_a_dg, hvp_y_dg, nrow = 3)

#cat("High Blood Pressure (Hypertension) Diagnosis")
hbp_ad_dg <- boxp_funct(hbp_derived_age, "High Blood Pressure Age at Diagnosis, Derived", "Age")
...
grid.arrange(hbp_ad_dg, hbp_a_dg, hbp_y_dg, nrow = 3)

#cat("Blood Clots (Deep Vein Thrombosis, Pulmonary Embolism) Diagnosis")
bc_ad_dg <- boxp_funct(bc_derived_age, "Blood Clot Age at Diagnosis, Derived", "Age")
...
grid.arrange(bc_ad_dg, bc_a_dg, bc_y_dg, nrow = 3)


#cat("Stroke Diagnosis")
stroke_ad_dg <- boxp_funct(stroke_derived_age, "Stroke Age at Diagnosis, Derived", "Age")
...
grid.arrange(stroke_ad_dg, stroke_a_dg, stroke_y_dg, nrow = 3)
...
mhgroup8_long <- mhgroup8_flags %>%
  ...
  mutate(Condition = case_when(
    ...
    Condition == "Ductal_Carcinoma" ~ "Ductal Carcinoma in situ",
    Condition == "None" ~ "None of the Above",
    Condition == "Skipped" ~ "Skipped this Question"
  ))
...
prost_y_sg=boxp_funct(D_882152987_D_802622485,"Year of Tubal Prostatectomy Surgery","Year") 
...
#Clearing up some memory -- removing all but the main dataframe and functions
rm(list = setdiff(ls(), c("data_tib_m1", 'module1', "dict", 'hist_funct', 'boxp_funct', 'simple_funct', 'one_logic_funct', 'sib_logic_funct', 'child_logic_funct',
                          'create_kable_table', 'create_kable_table_w_footnote', 'create_kable_table_w_ethnicity_footnote')))
