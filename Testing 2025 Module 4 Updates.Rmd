...
```{r Commuting_Current, warning=FALSE, echo=FALSE, message=FALSE}

work19_postpan= Mod4 %>%  filter(as.Date(d_452942800) > "2025-03-24") %>% 
  mutate(Address1= case_when(is.na(D_699873889)~"Skipped WORK2019POSTPAN"))

dt_work19_postpan_summary <- work19_postpan %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_work19_postpan_summary <- dt_work19_postpan_summary[1,]

dt_work19_postpan_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Currently Working for Pay")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
days_work19_postpan= Mod4 %>%  filter(as.Date(d_452942800) > "2025-03-24" & D_699873889==353358909) %>%  
  mutate(Address1= case_when(is.na(D_774087638)~"Skipped DAYSWORKPOSTPAN"))

dt_days_work19_postpan_summary <- days_work19_postpan %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_days_work19_postpan_summary <- dt_days_work19_postpan_summary[1,]

dt_days_work19_postpan_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Days per Week Currently Working")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
longest_postpan= Mod4 %>%  filter(as.Date(d_452942800) > "2025-03-24" & D_699873889==353358909) %>%  
  mutate(Address1= case_when(is.na(D_858178137)~"Skipped LONGESTJOBPOSTPAN]"))

dt_longest_postpan_summary <- longest_postpan %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_longest_postpan_summary <- dt_longest_postpan_summary[1,]

dt_longest_postpan_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Current Job the Longest Held Job")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
## Work Commute After the COVID-19 Pandemic
```{r Post_COVID, warning=FALSE, echo=FALSE, message=FALSE}
days_work19_postpan= Mod4 %>%  filter(as.Date(d_452942800) > "2025-03-24" & D_699873889==353358909) %>%  
  mutate(Address1= case_when(is.na(D_871276836)~"Skipped WORKRESPOSTPAN"))
...
dt_days_work19_postpan_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Daily Current Work Tasks Include Driving")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
commute_postpan_num= Mod4 %>%  filter(as.Date(d_452942800) > "2025-03-24" & D_871276836==104430631) %>%  
  mutate(Address1= case_when(is.na(D_660218333)~"Skipped NUMWORKPOSTPAN"))

dt_commute_postpan_num_summary <- commute_postpan_num %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_commute_postpan_num_summary <- dt_commute_postpan_num_summary[1,]

dt_commute_postpan_num_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Number of Current Commutes to Different Workplaces per Week")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
curwork_postpan= Mod4 %>%  filter(as.Date(d_452942800) > "2025-03-24" & 
                                    Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360) %>%  
  mutate(Address1= case_when(is.na(D_263959391_D_560853245) & is.na(D_263959391_D_307515427)& is.na(D_263959391_D_422521705) & is.na(D_263959391_D_627183798)& 
                               is.na(D_263959391_D_901141257)& is.na(D_263959391_D_599770535)& is.na(D_263959391_D_268600708) ~"Skipped All Current Employer Info"))

dt_curwork_postpan_summary <- curwork_postpan %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
...
dt_curwork_postpan_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
curwork_postpan2= Mod4 %>%  filter(as.Date(d_452942800) > "2025-03-24" & Mod4$D_871276836!=353358909 & Mod4$D_263588196_D_263588196!="[178420302]" & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360)) %>%  
  mutate(Address1= case_when(is.na(D_263959391_D_627183798) & is.na(D_986316055_D_515150210) ~"Skipped City"))

dt_curwork_postpan2_summary <- curwork_postpan2 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
...
dt_curwork_postpan2_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
curwork_postpan3= Mod4 %>% 
  filter(as.Date(d_452942800) > "2025-03-24" & 
           (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360) &
           Mod4$D_116032363_D_116032363!="[178420302]" & Mod4$D_871276836!=353358909 &
           is.na(Mod4$D_263959391_D_307515427) & is.na(Mod4$D_263959391_D_422521705) & ((!is.na(Mod4$D_263959391_D_627183798) | !is.na(Mod4$D_263959391_D_901141257) | 
                                                                                           !is.na(Mod4$D_263959391_D_599770535) | !is.na(Mod4$D_263959391_D_268600708)) | 
                                                                                          (!is.na(Mod4$D_986316055_D_515150210) | !is.na(Mod4$D_986316055_D_182449282) |
                                                                                             !is.na(Mod4$D_986316055_D_609408466) |!is.na(Mod4$D_986316055_D_702591232))))


curwork_postpan3= curwork_postpan3 %>%  mutate(Address1= case_when(is.na(D_116032363_D_330163034) ~"Skipped Cross Street 1"))

dt_curwork_postpan3_summary <- curwork_postpan3 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
...
dt_curwork_postpan3_summary[2,3] <- (sum(is.na(curwork_postpan3$D_116032363_D_555595404))/dim(curwork_postpan3)[[1]])*100

dt_curwork_postpan3_summary <- dt_curwork_postpan3_summary[2,]
dt_curwork_postpan3_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
curwork_postpanYR1_MOS= Mod4 %>%   
  filter(as.Date(d_452942800) > "2025-03-24" & 
           Mod4$D_871276836!=353358909 & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360))


curwork_postpanYR1_MOS= curwork_postpanYR1_MOS %>%  mutate(Address1= case_when(is.na(D_870675371_D_900611792) ~"Skipped Month Job Started"))

dt_curwork_postpanYR1_MOS_summary <- curwork_postpanYR1_MOS %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
...
dt_curwork_postpanYR1_MOS_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
curwork_postpanT1= Mod4 %>%   
  filter(as.Date(d_452942800) > "2025-03-24" &  Mod4$D_871276836!=353358909 & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360))

curwork_postpanT1= curwork_postpanT1 %>%  mutate(Address1= case_when(is.na(D_421586693_D_421586693_D_767755239) ~"Skipped if Commute Inlcudes a Car"))

dt_curwork_postpanT1_summary <- curwork_postpanT1 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
...
dt_curwork_postpanT1_summary[2,2] <- ifelse (exists("curwork_postpanT1$D_421586693_D_421586693_D_385609081"), sum(is.na(curwork_postpanT1$D_421586693_D_421586693_D_385609081)), 0)
...
dt_curwork_postpanT1_summary[8,2] <- sum(is.na(curwork_postpanT1$D_421586693_D_421586693_D_466212511))
dt_curwork_postpanT1_summary[8,3] <- (sum(is.na(curwork_postpanT1$D_421586693_D_421586693_D_466212511))/dim(curwork_postpanT1)[[1]])*100


dt_curwork_postpanT1_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
curwork_postpanT2A_H= Mod4 %>%   
  # filter( (is.na(D_440093675_D_593010802) & D_421586693_D_421586693_D_767755239==1 | 
  #            is.na(D_440093675_D_453004768) & D_421586693_D_421586693_D_385609081==1 |
  #            is.na(D_440093675_D_511991969) & D_421586693_D_421586693_D_502946054==1 |
  #            is.na(D_440093675_D_546570171) & D_421586693_D_421586693_D_151757360==1 |
  #            is.na(D_440093675_D_242761203) & D_421586693_D_421586693_D_363747463==1 |
  #            is.na(D_440093675_D_587434250) & D_421586693_D_421586693_D_626380300==1 |
  #            is.na(D_440093675_D_569993305) & D_421586693_D_421586693_D_817932069==1 |
  #            is.na(D_440093675_D_662584384) & D_421586693_D_421586693_D_466212511==1 ) &
  #           Mod4$D_871276836!=353358909 & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360) & 
  #          (Mod4$D_421586693_D_421586693_D_385609081==1 | Mod4$D_421586693_D_421586693_D_767755239==1 | Mod4$D_421586693_D_421586693_D_502946054==1 |
  #             Mod4$D_421586693_D_421586693_D_151757360==1 | is.na(Mod4$D_440093675_D_453004768) | is.na(Mod4$D_440093675_D_453004768)))
    filter(as.Date(d_452942800) > "2025-03-24" & 
             D_421586693_D_421586693_D_767755239==1 | 
           #D_421586693_D_421586693_D_385609081==1 |
           D_421586693_D_421586693_D_502946054==1 |
           D_421586693_D_421586693_D_151757360==1 |
           D_421586693_D_421586693_D_363747463==1 |
           D_421586693_D_421586693_D_626380300==1 |
           D_421586693_D_421586693_D_817932069==1 |
           D_421586693_D_421586693_D_466212511==1) 

curwork_postpanT2A_H= curwork_postpanT2A_H %>%  
  mutate(Address1= case_when(is.na(D_733638576_D_583216333) & D_421586693_D_421586693_D_767755239==1 ~"Skipped Time Spent in a Car"))

dt_curwork_postpanT2A_H_summary <- curwork_postpanT2A_H %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
...
#ifelse (exists("D_404863614_D_404863614_D_638833327"), taxi <- curwork_postpanT2A_H %>% filter(D_404863614_D_404863614_D_638833327==1), taxi <- curwork_postpanT2A_H)
dt_curwork_postpanT2A_H_summary[2,2] <- ifelse (exists("D_733638576_D_920653797"),  sum(is.na(taxi$D_733638576_D_920653797)), 0)
dt_curwork_postpanT2A_H_summary[2,3] <- ifelse (exists("D_733638576_D_920653797"), (sum(is.na(taxi$D_733638576_D_920653797))/dim(taxi)[[1]])*100, 0)
...
dt_curwork_postpanT2A_H_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
curwork_postpanT3= Mod4 %>%  filter(#(Mod4$D_733638576_D_583216333!=428999623 & !is.na(Mod4$D_733638576_D_583216333))
                                    as.Date(d_452942800) > "2025-03-24" & 
                                    (Mod4$D_733638576_D_583216333!=428999623 & !is.na(Mod4$D_733638576_D_583216333)) | #(Mod4$D_733638576_D_920653797!=428999623 & !is.na(Mod4$D_733638576_D_920653797)) |
                                    (Mod4$D_733638576_D_843066684!=428999623 & !is.na(Mod4$D_733638576_D_843066684)) | (Mod4$D_733638576_D_101850740!=428999623 & !is.na(Mod4$D_733638576_D_101850740))) %>% 
  mutate(Address1= case_when(is.na(D_166943843) ~"Skipped Time on Highways"))

dt_curwork_postpanT3_summary <- curwork_postpanT3 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_curwork_postpanT3_summary <- dt_curwork_postpanT3_summary[1,]

dt_curwork_postpanT3_summary[2,1] <- "Skipped Time on Major Roads" 
dt_curwork_postpanT3_summary[2,2] <- sum(is.na(curwork_postpanT3$D_173155090))
dt_curwork_postpanT3_summary[2,3] <- (sum(is.na(curwork_postpanT3$D_173155090))/dim(curwork_postpanT3)[[1]])*100

dt_curwork_postpanT3_summary[3,1] <- "Skipped Time on  Local Roads" 
dt_curwork_postpanT3_summary[3,2] <- sum(is.na(curwork_postpanT3$D_234136107))
dt_curwork_postpanT3_summary[3,3] <- (sum(is.na(curwork_postpanT3$D_234136107))/dim(curwork_postpanT3)[[1]])*100


dt_curwork_postpanT3_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Time Commuting on Highways, Parkways, Freeways or \n Toll Roads (Current Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
curwork_postpanT4_5= Mod4 %>%  filter( #(is.na(Mod4$D_166943843) | is.na(Mod4$D_173155090) | is.na(Mod4$D_234136107)) & 
                                   #Mod4$D_871276836!=353358909 & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360) &
            as.Date(d_452942800) > "2025-03-24" & 
            (Mod4$D_733638576_D_583216333!=428999623 & !is.na(Mod4$D_733638576_D_583216333)) | #(Mod4$D_733638576_D_920653797!=428999623 & !is.na(Mod4$D_733638576_D_920653797)) |
            (Mod4$D_733638576_D_843066684!=428999623 & !is.na(Mod4$D_733638576_D_843066684)) | (Mod4$D_733638576_D_101850740!=428999623 & !is.na(Mod4$D_733638576_D_101850740)) |
            (Mod4$D_733638576_D_317194063!=428999623 & !is.na(Mod4$D_733638576_D_317194063)) | (Mod4$D_733638576_D_621948602!=428999623 & !is.na(Mod4$D_733638576_D_621948602)) |
            (Mod4$D_733638576_D_175502589!=428999623 & !is.na(Mod4$D_733638576_D_175502589)) |(Mod4$D_733638576_D_614443767!=428999623 & !is.na(Mod4$D_733638576_D_614443767))) %>% 
  mutate(Address1= case_when(is.na(D_173155090) ~"Skipped Time on Major Roads"))

dt_curwork_postpanT4_5_summary <- curwork_postpanT4_5 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_curwork_postpanT4_5_summary <- dt_curwork_postpanT4_5_summary[1,]

dt_curwork_postpanT4_5_summary[2,1] <- "Skipped Time on  Local Roads" 
dt_curwork_postpanT4_5_summary[2,2] <- sum(is.na(curwork_postpanT4_5$D_234136107))
dt_curwork_postpanT4_5_summary[2,3] <- (sum(is.na(curwork_postpanT4_5$D_234136107))/dim(curwork_postpanT4_5)[[1]])*100


dt_curwork_postpanT4_5_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
curwork_postpanT6_7= Mod4 %>%  filter(as.Date(d_452942800) > "2025-03-24" & 
                                        (D_421586693_D_421586693_D_767755239==0 &  #D_421586693_D_421586693_D_385609081==0 & 
                                         D_421586693_D_421586693_D_502946054==0 &
                                         D_421586693_D_421586693_D_151757360==0 & D_421586693_D_421586693_D_363747463==0 & D_421586693_D_421586693_D_626380300==0 &
                                         D_421586693_D_421586693_D_817932069==0 & D_421586693_D_421586693_D_466212511==0) |
                                        ((Mod4$D_733638576_D_583216333==428999623 | is.na(Mod4$D_733638576_D_583216333)) & #(Mod4$D_733638576_D_920653797==428999623 | is.na(Mod4$D_733638576_D_920653797)) &
                                           (Mod4$D_733638576_D_843066684==428999623 | is.na(Mod4$D_733638576_D_843066684)) & (Mod4$D_733638576_D_101850740==428999623 | is.na(Mod4$D_733638576_D_101850740)) &
                                           (Mod4$D_733638576_D_317194063==428999623 | is.na(Mod4$D_733638576_D_317194063)) & (Mod4$D_733638576_D_621948602==428999623 | is.na(Mod4$D_733638576_D_621948602)) &
                                           (Mod4$D_733638576_D_175502589==428999623 | is.na(Mod4$D_733638576_D_175502589)) & (Mod4$D_733638576_D_614443767==428999623 | is.na(Mod4$D_733638576_D_614443767)))) %>% 
  mutate(Address1= case_when(is.na(D_666629067) ~"Days per Week"))

dt_curwork_postpanT6_7_summary <- curwork_postpanT6_7 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_curwork_postpanT6_7_summary <- dt_curwork_postpanT6_7_summary[1,]

dt_curwork_postpanT6_7_summary[2,1] <- "Same Transportation to and from" 
dt_curwork_postpanT6_7_summary[2,2] <- sum(is.na(curwork_postpanT6_7$D_614208066))
dt_curwork_postpanT6_7_summary[2,3] <- (sum(is.na(curwork_postpanT6_7$D_614208066))/dim(curwork_postpanT6_7)[[1]])*100


dt_curwork_postpanT6_7_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Commuting from Home to Work (Current Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
curwork_postpanT8= Mod4  %>%  filter(as.Date(d_452942800) > "2025-03-24" & D_614208066==353358909) %>%  
  mutate(Address1= case_when(is.na(D_308634850) ~"Skipped curwork_postpanT8"))
         
dt_curwork_postpanT8_summary <- curwork_postpanT8 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_curwork_postpanT8_summary <- dt_curwork_postpanT8_summary[1,]

dt_curwork_postpanT8_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
curwork_postpanT9= Mod4 %>% filter(as.Date(d_452942800) > "2025-03-24" & D_614208066!=353358909)

curwork_postpanT9= curwork_postpanT9 %>%  mutate(Address1= case_when(is.na(D_799598595_D_799598595_D_339946103) ~"Skipped if Commute Inlcudes a Car"))

dt_curwork_postpanT9_summary <- curwork_postpanT9 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
...
dt_curwork_postpanT9_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
###############   So far the only response is for car, so the rest is commented out

curwork_postpanT10A= Mod4 %>%   
  # filter(is.na(Mod4$D_532260562_D_659799855) & Mod4$D_203943120!=353358909 & Mod4$D_871276836!=353358909 & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360) &
  #          ifelse(Mod4$D_684542266==104430631, Mod4$D_799598595_D_799598595_D_339946103==1,
  #                 ifelse(is.na(Mod4$D_684542266), Mod4$D_799598595_D_799598595_D_339946103==1,
  #                        ifelse(Mod4$D_203943120==104430631, Mod4$D_421586693_D_421586693_D_767755239==1,
  #                               ifelse(is.na(Mod4$D_203943120), Mod4$D_421586693_D_421586693_D_767755239==1, TRUE))))) ##should this be else true or else NA? Doesn't seem to change outcome
  filter(as.Date(d_452942800) > "2025-03-24" & D_799598595_D_799598595_D_339946103==1) 
curwork_postpanT10A= curwork_postpanT10A %>%  mutate(Address1= case_when(is.na(D_532260562_D_827461454) ~"Skipped curwork_postpanT10A"))

dt_curwork_postpanT10A_summary <- curwork_postpanT10A %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)


dt_curwork_postpanT10A_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
# curwork_postpanT10B= Mod4 %>%   
#   # filter(is.na(Mod4$D_532260562_D_552410034) & Mod4$D_203943120!=353358909 & Mod4$D_871276836!=353358909 & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360) &
#   #          ifelse(Mod4$D_684542266==104430631, Mod4$D_799598595_D_799598595_D_364857371==1,
#   #                 ifelse(is.na(Mod4$D_684542266), Mod4$D_799598595_D_799598595_D_364857371==1,
#   #                        ifelse(Mod4$D_203943120==104430631, Mod4$D_421586693_D_421586693_D_385609081==1,
#   #                               ifelse(is.na(Mod4$D_203943120), Mod4$D_421586693_D_421586693_D_385609081==1, NA)))))
#   filter(as.Date(d_452942800) > "2025-03-24" & D_799598595_D_799598595_D_364857371==1)
# curwork_postpanT10B= curwork_postpanT10B %>%  mutate(Address1= case_when(is.na(D_532260562_D_306356124) ~"Skipped curwork_postpanT10B"))
# 
# dt_curwork_postpanT10B_summary <- curwork_postpanT10B %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
# 
# 
# dt_curwork_postpanT10B_summary %>%  gt::gt() %>%  
#   fmt_number(columns = "percentage", decimals = 2) %>% 
...
# curwork_postpanT10C= Mod4 %>%  
#   # filter(is.na(Mod4$D_532260562_D_772382520)  & Mod4$D_203943120!=353358909 & Mod4$D_871276836!=353358909 & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360) &
#   #          ifelse(Mod4$D_684542266==104430631, Mod4$D_799598595_D_799598595_D_315356220==1,
#   #                 ifelse(is.na(Mod4$D_684542266), Mod4$D_799598595_D_799598595_D_315356220==1,
#   #                        ifelse(Mod4$D_203943120==104430631, Mod4$D_421586693_D_421586693_D_502946054==1,
#   #                               ifelse(is.na(Mod4$D_203943120), Mod4$D_421586693_D_421586693_D_502946054==1, NA)))))
#   filter(as.Date(d_452942800) > "2025-03-24" & D_799598595_D_799598595_D_315356220==1)
# curwork_postpanT10C= curwork_postpanT10C %>%  mutate(Address1= case_when(is.na(D_532260562_D_884514292) ~"Skipped curwork_postpanT10C"))
# 
# dt_curwork_postpanT10C_summary <- curwork_postpanT10C %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
# 
# 
# dt_curwork_postpanT10C_summary %>%  gt::gt() %>%
#   fmt_number(columns = "percentage", decimals = 2) %>%
...
# 
# curwork_postpanT10D= Mod4 %>%   
#   # filter(is.na(Mod4$D_532260562_D_146307133) & Mod4$D_203943120!=353358909 & Mod4$D_871276836!=353358909 & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360) &
#   #          ifelse(Mod4$D_684542266==104430631, Mod4$D_799598595_D_799598595_D_363036517==1,
#   #                 ifelse(is.na(Mod4$D_684542266), Mod4$D_799598595_D_799598595_D_363036517==1,
#   #                        ifelse(Mod4$D_203943120==104430631, Mod4$D_421586693_D_421586693_D_151757360==1,
#   #                               ifelse(is.na(Mod4$D_203943120), Mod4$D_421586693_D_421586693_D_151757360==1, NA)))))
#   filter(as.Date(d_452942800) > "2025-03-24" & D_799598595_D_799598595_D_363036517==1)
# curwork_postpanT10D= curwork_postpanT10D %>%  mutate(Address1= case_when(is.na(D_532260562_D_570556451) ~"Skipped curwork_postpanT10D"))
# 
# dt_curwork_postpanT10D_summary <- curwork_postpanT10D %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
# 
# 
# dt_curwork_postpanT10D_summary %>%  gt::gt() %>%  
#   fmt_number(columns = "percentage", decimals = 2) %>% 
...
# curwork_postpanT10E= Mod4 %>%  
#   # filter(is.na(Mod4$D_532260562_D_100591237) & Mod4$D_203943120!=353358909 & Mod4$D_871276836!=353358909 & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360) &
#   #          ifelse(Mod4$D_684542266==104430631, Mod4$D_799598595_D_799598595_D_978362655==1,
#   #                 ifelse(is.na(Mod4$D_684542266), Mod4$D_799598595_D_799598595_D_978362655==1,
#   #                        ifelse(Mod4$D_203943120==104430631, Mod4$D_421586693_D_421586693_D_363747463==1,
#   #                               ifelse(is.na(Mod4$D_203943120), Mod4$D_421586693_D_421586693_D_363747463==1, NA)))))
#   filter(as.Date(d_452942800) > "2025-03-24" & D_799598595_D_799598595_D_978362655==1)
# curwork_postpanT10E= curwork_postpanT10E %>%  mutate(Address1= case_when(is.na(D_532260562_D_303089793) ~"Skipped curwork_postpanT10E"))
# 
# dt_curwork_postpanT10E_summary <- curwork_postpanT10E %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
# 
# 
# dt_curwork_postpanT10E_summary %>%  gt::gt() %>%  
#   fmt_number(columns = "percentage", decimals = 2) %>% 
...
# curwork_postpanT10F= Mod4 %>%   
#   # filter(is.na(Mod4$D_532260562_D_823402922) & Mod4$D_203943120!=353358909 & Mod4$D_871276836!=353358909 & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360) &
#   #          ifelse(Mod4$D_684542266==104430631, Mod4$D_799598595_D_799598595_D_175003260==1,
#   #                 ifelse(is.na(Mod4$D_684542266), Mod4$D_799598595_D_799598595_D_175003260==1,
#   #                        ifelse(Mod4$D_203943120==104430631, Mod4$D_421586693_D_421586693_D_626380300==1,
#   #                               ifelse(is.na(Mod4$D_203943120), Mod4$D_421586693_D_421586693_D_626380300==1, NA)))))
#   filter(as.Date(d_452942800) > "2025-03-24" & D_799598595_D_799598595_D_175003260==1)
# curwork_postpanT10F= curwork_postpanT10F %>%  mutate(Address1= case_when(is.na(D_532260562_D_848543458) ~"Skipped curwork_postpanT10F"))
# 
# dt_curwork_postpanT10F_summary <- curwork_postpanT10F %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
# 
# 
# dt_curwork_postpanT10F_summary %>%  gt::gt() %>%  
#   fmt_number(columns = "percentage", decimals = 2) %>% 
...
# curwork_postpanT10G= Mod4 %>%  
#   # filter(is.na(Mod4$D_532260562_D_289302451) & Mod4$D_203943120!=353358909 & Mod4$D_871276836!=353358909 & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360) &
#   #          ifelse(Mod4$D_684542266==104430631, Mod4$D_799598595_D_799598595_D_648051649==1,
#   #                 ifelse(is.na(Mod4$D_684542266), Mod4$D_799598595_D_799598595_D_648051649==1,
#   #                        ifelse(Mod4$D_203943120==104430631, Mod4$D_421586693_D_421586693_D_817932069==1,
#   #                               ifelse(is.na(Mod4$D_203943120), Mod4$D_421586693_D_421586693_D_817932069==1, NA)))))
#   filter(as.Date(d_452942800) > "2025-03-24" & D_799598595_D_799598595_D_648051649==1)
# curwork_postpanT10F= curwork_postpanT10F %>%  mutate(Address1= case_when(is.na(D_532260562_D_543804307) ~"Skipped curwork_postpanT10G"))
# 
# dt_curwork_postpanT10F_summary <- curwork_postpanT10F %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
# 
# 
...
# curwork_postpanT10H= Mod4 %>%  select(D_532260562_D_654108399) %>%  
#   # filter(Mod4$D_203943120!=353358909 & Mod4$D_871276836!=353358909 & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360) &
#   #          ifelse(Mod4$D_684542266==104430631, is.na(Mod4$D_799598595_D_799598595_D_968445508),
#   #                 ifelse(is.na(Mod4$D_684542266), is.na(Mod4$D_799598595_D_799598595_D_968445508),
#   #                        ifelse(Mod4$D_203943120==104430631, is.na(Mod4$D_421586693_D_421586693_D_421586693_D_466212511),
#   #                               ifelse(is.na(Mod4$D_203943120), is.na(Mod4$D_421586693_D_421586693_D_421586693_D_466212511), NA)))))
#   filter(as.Date(d_452942800) > "2025-03-24" & D_799598595_D_799598595_D_957052257==1)
# curwork_postpanT10F= curwork_postpanT10H %>%  mutate(Address1= case_when(is.na(D_532260562_D_654108399) ~"Skipped curwork_postpanT10H"))





### This will have to be updated once more responses above are selected
curwork_postpanT11= Mod4 %>%   
  filter(as.Date(d_452942800) > "2025-03-24" & (Mod4$D_532260562_D_827461454!=428999623 & !is.na(Mod4$D_532260562_D_827461454)) | #(Mod4$D_532260562_D_306356124!=428999623 & !is.na(Mod4$D_532260562_D_306356124)) |
            (Mod4$D_532260562_D_884514292!=428999623 & !is.na(Mod4$D_532260562_D_884514292))) #| (Mod4$D_532260562_D_570556451!=428999623 & !is.na(Mod4$D_532260562_D_570556451)))



curwork_postpanT11= curwork_postpanT11 %>%  mutate(Address1= case_when(is.na(D_186636914) ~"Skipped if it Includes Highways"))

dt_curwork_postpanT11_summary <- curwork_postpanT11 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_curwork_postpanT11_summary <- dt_curwork_postpanT11_summary[1,]

dt_curwork_postpanT11_summary[2,1] <- "Skipped if it Includes Major Roads" 
dt_curwork_postpanT11_summary[2,2] <- sum(is.na(curwork_postpanT11$D_936393993))
dt_curwork_postpanT11_summary[2,3] <- (sum(is.na(curwork_postpanT11$D_936393993))/dim(curwork_postpanT11)[[1]])*100

dt_curwork_postpanT11_summary[3,1] <- "Skipped if it Includes Local Roads" 
dt_curwork_postpanT11_summary[3,2] <- sum(is.na(curwork_postpanT11$D_168563469))
dt_curwork_postpanT11_summary[3,3] <- (sum(is.na(curwork_postpanT11$D_168563469))/dim(curwork_postpanT11)[[1]])*100

dt_curwork_postpanT11_summary <- dt_curwork_postpanT11_summary[c(2,3),]
dt_curwork_postpanT11_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
curwork_postpanT12_13= Mod4 %>%   
  filter( #Mod4$D_871276836!=353358909 & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360) &
            as.Date(d_452942800) > "2025-03-24" & 
              (Mod4$D_532260562_D_827461454!=428999623 & !is.na(Mod4$D_532260562_D_827461454)) | #(Mod4$D_532260562_D_306356124!=428999623 & !is.na(Mod4$D_532260562_D_306356124)) |
            (Mod4$D_532260562_D_884514292!=428999623 & !is.na(Mod4$D_532260562_D_884514292)) | #(Mod4$D_532260562_D_570556451!=428999623 & !is.na(Mod4$D_532260562_D_570556451)) |
            #(Mod4$D_532260562_D_303089793!=428999623 & !is.na(Mod4$D_532260562_D_303089793)) | 
              (Mod4$D_532260562_D_848543458!=428999623 & !is.na(Mod4$D_532260562_D_848543458)) |
            (Mod4$D_532260562_D_543804307!=428999623 & !is.na(Mod4$D_532260562_D_543804307)) |(Mod4$D_532260562_D_654108399!=428999623 & !is.na(Mod4$D_532260562_D_654108399)))



curwork_postpanT12_13= curwork_postpanT12_13 %>%  mutate(Address1= case_when(is.na(D_568581510) ~"Skipped Major City"))

dt_curwork_postpanT12_13_summary <- curwork_postpanT12_13 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_curwork_postpanT12_13_summary <- dt_curwork_postpanT12_13_summary[1,]

dt_curwork_postpanT12_13_summary[2,1] <- "Skipped Local or neighborhood Roadway" 
dt_curwork_postpanT12_13_summary[2,2] <- sum(is.na(curwork_postpanT12_13$D_277953784))
dt_curwork_postpanT12_13_summary[2,3] <- (sum(is.na(curwork_postpanT12_13$D_277953784))/dim(curwork_postpanT12_13)[[1]])*100


dt_curwork_postpanT12_13_summary <- dt_curwork_postpanT12_13_summary[c(2,3),]
dt_curwork_postpanT12_13_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Travel Path Commuting Home (Current Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
curwork_postpanT14= Mod4 %>%  filter(as.Date(d_452942800) > "2025-03-24" & D_871276836!=353358909 & (Mod4$D_660218333==759356722 | Mod4$D_660218333==185036360)) %>% 
  mutate(Address1= case_when(is.na(D_510872569) ~"Skipped curwork_postpanT14"))

dt_curwork_postpanT14_summary <- curwork_postpanT14 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_curwork_postpanT14_summary <- dt_curwork_postpanT14_summary[1,]

dt_curwork_postpanT14_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
```{r Commuting_Before, warning=FALSE, echo=FALSE, message=FALSE}

work19= Mod4 %>%  
  filter(D_699873889!=353358909 | D_871276836!=353358909 | 
           (D_660218333==684900118 | is.na(D_660218333))) %>% 
...
samejobprepan= Mod4 %>%  filter(Mod4$D_694113343==353358909 & D_699873889==353358909) %>%  
  mutate(Address1= case_when(is.na(D_576417612)~"Skipped SAMEJOBPREPAN"))

dt_samejobprepan_summary <- samejobprepan %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_samejobprepan_summary <- dt_samejobprepan_summary[1,]

dt_samejobprepan_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("If Job from 2019 is the Same Job Held Now")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
workres= Mod4 %>%  filter(D_576417612!=353358909 | 
                            (D_694113343==353358909 & D_699873889!=353358909)) %>%  
  mutate(Address1= case_when(is.na(D_374639590)~"Skipped WORKRES"))

dt_workres_summary <- workres %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_workres_summary <- dt_workres_summary[1,]

dt_workres_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
### SAMEJOBPAN=1 AND WORKRESPOSTPAN=0
days_work19= Mod4 %>%  filter(D_576417612==353358909 & D_871276836==104430631) %>%  
  mutate(Address1= case_when(is.na(D_970148613)~"Skipped PREPANDIFF"))
...
dt_days_work19_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Workplace Commuting Pattern Change Because of COVID-19")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
### WORK2019=1 AND (WORKRES=0 ore PREPANDIFF=1) 
days_work19= Mod4 %>%  filter(D_694113343==353358909 & (D_871276836==104430631 | D_970148613==353358909)) %>%  
...
```{r PreCOVID_before, warning=FALSE, echo=FALSE, message=FALSE}


commute_num= Mod4 %>%  filter(D_694113343==353358909 | D_374639590==104430631 | D_970148613==353358909) %>%  
...
## PREPANDIFF= 1 AND (ADDRESS ENTERED IN CURWORKPOSTPAN1_SRC, CURWORKPOSTPAN2_SRC, OR CURWORKPOSTPAN3_SRC)
curwork0= Mod4 %>%  filter(D_970148613==353358909 &
                             (!is.na(D_263959391_D_268600708) | !is.na(D_263959391_D_560853245) | !is.na(D_263959391_D_307515427) | !is.na(D_263959391_D_422521705) |
                                !is.na(D_263959391_D_627183798) | !is.na(D_263959391_D_901141257) |  !is.na(D_263959391_D_599770535) | !is.na(D_263959391_D_268600708) | 
                                !is.na(D_986316055_D_515150210) | !is.na(D_986316055_D_182449282) |!is.na(D_986316055_D_609408466) |!is.na(D_986316055_D_702591232) | 
                                !is.na(D_116032363_D_330163034) | !is.na(D_116032363_D_555595404))) %>%  
  mutate(Address1= case_when(is.na(D_211472150)~"Skipped CURWORK0"))

dt_curwork0_summary <- curwork0 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_curwork0_summary <- dt_curwork0_summary[1,]

dt_curwork0_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Before COVID-19, was Current Workplace Still \n the Same Workplace Most Often Commuted to")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
### (CURWORK0= 0, NR) OR ([NUMWORK= 0 OR 1] AND [WORKRES= 0]) OR ([PREPANDIFF= 1] AND [NO ADDRESS ENTERED IN CURWORKPOSTPAN1_SRC, CURWORKPOSTPAN2_SRC, OR CURWORKPOSTPAN3_SRC])
curwork= Mod4 %>%  filter(D_211472150!=353358909 | 
                            ((Mod4$D_828801156==759356722 | Mod4$D_828801156==185036360) & D_374639590==104430631) |
                            (D_970148613==353358909 &
                             !(!is.na(D_263959391_D_268600708) | !is.na(D_263959391_D_560853245) | !is.na(D_263959391_D_307515427) | !is.na(D_263959391_D_422521705) |
                                !is.na(D_263959391_D_627183798) | !is.na(D_263959391_D_901141257) |  !is.na(D_263959391_D_599770535) | !is.na(D_263959391_D_268600708) | 
                                !is.na(D_986316055_D_515150210) | !is.na(D_986316055_D_182449282) |!is.na(D_986316055_D_609408466) |!is.na(D_986316055_D_702591232) | 
                                !is.na(D_116032363_D_330163034) | !is.na(D_116032363_D_555595404)))) %>%  
...
dt_curwork_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Previous Employer (Most Often Commuted to)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
dt_curwork2_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Previous Employer Address Follow-Up")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
dt_CURWORK3_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Previous Employer Buidling Cross Streets")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
dt_CURWORKYR1_MOS_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Commuting to Previous Employer")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
CURWORKT1= Mod4 %>% filter(D_211472150==353358909)
...
dt_CURWORKT1_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Commuting Methods to Work (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
CURWORKT2A_H= Mod4 %>%   
  ...
  #             Mod4$D_635467479_D_635467479_D_177539753==1 | is.na(Mod4$D_440093675_D_453004768) | is.na(Mod4$D_440093675_D_453004768)))
    filter(D_635467479_D_635467479_D_158795242==1 | 
           D_635467479_D_635467479_D_443596662==1 |
           D_635467479_D_635467479_D_892894242==1 |
           D_635467479_D_635467479_D_177539753==1 |
           D_635467479_D_635467479_D_107659596==1 |
           D_635467479_D_635467479_D_575883949==1 |
           D_635467479_D_635467479_D_248168118==1 |
           D_635467479_D_635467479_D_509121242==1)
...
dt_CURWORKT2A_H_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Time Spent in Each Commuting Method (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
CURWORKT3= Mod4 %>%  filter( #(is.na(Mod4$D_155199731) | is.na(Mod4$D_181422361) | is.na(Mod4$D_333362587)) & 
                                   #Mod4$D_374639590!=353358909 & (Mod4$D_828801156==759356722 | Mod4$D_828801156==185036360) &
...
dt_CURWORKT3_summary <- CURWORKT3 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_CURWORKT3_summary <- dt_CURWORKT3_summary[1,]

dt_CURWORKT3_summary[2,1] <- "Skipped Time on Major Roads" 
dt_CURWORKT3_summary[2,2] <- sum(is.na(CURWORKT3$D_181422361))
dt_CURWORKT3_summary[2,3] <- (sum(is.na(CURWORKT3$D_181422361))/dim(CURWORKT3)[[1]])*100

dt_CURWORKT3_summary[3,1] <- "Skipped Time on  Local Roads" 
dt_CURWORKT3_summary[3,2] <- sum(is.na(CURWORKT3$D_333362587))
dt_CURWORKT3_summary[3,3] <- (sum(is.na(CURWORKT3$D_333362587))/dim(CURWORKT3)[[1]])*100


dt_CURWORKT3_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Time Commuting on Road Types (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
CURWORKT4_5= Mod4 %>%  filter( #(is.na(Mod4$D_155199731) | is.na(Mod4$D_181422361) | is.na(Mod4$D_333362587)) & 
                                   #Mod4$D_374639590!=353358909 & (Mod4$D_828801156==759356722 | Mod4$D_828801156==185036360) &
            (Mod4$D_440093675_D_593010802!=428999623 & !is.na(Mod4$D_440093675_D_593010802)) | (Mod4$D_440093675_D_453004768!=428999623 & !is.na(Mod4$D_440093675_D_453004768)) |
            (Mod4$D_440093675_D_511991969!=428999623 & !is.na(Mod4$D_440093675_D_511991969)) | (Mod4$D_440093675_D_546570171!=428999623 & !is.na(Mod4$D_440093675_D_546570171)) |
...
dt_CURWORKT4_5_summary <- CURWORKT4_5 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_CURWORKT4_5_summary <- dt_CURWORKT4_5_summary[1,]

dt_CURWORKT4_5_summary[2,1] <- "Skipped Time on Major Roads" 
dt_CURWORKT4_5_summary[2,2] <- sum(is.na(CURWORKT4_5$D_181422361))
dt_CURWORKT4_5_summary[2,3] <- (sum(is.na(CURWORKT4_5$D_181422361))/dim(CURWORKT4_5)[[1]])*100

dt_CURWORKT4_5_summary[3,1] <- "Skipped Time on  Local Roads" 
dt_CURWORKT4_5_summary[3,2] <- sum(is.na(CURWORKT4_5$D_333362587))
dt_CURWORKT4_5_summary[3,3] <- (sum(is.na(CURWORKT4_5$D_333362587))/dim(CURWORKT4_5)[[1]])*100


dt_CURWORKT4_5_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Time Commuting on Road Types (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
###  [CURWORKT1=NR] OR [CURWORKT2A:H=0, NR]
CURWORKT6_summary <- Mod4 %>% 
  #filter(Mod4$D_374639590!=353358909 & (Mod4$D_828801156==759356722 | Mod4$D_828801156==185036360) & is.na(D_839454121) ) %>% 
  filter(!(D_635467479_D_635467479_D_158795242==1 | 
           D_635467479_D_635467479_D_443596662==1 |
           D_635467479_D_635467479_D_892894242==1 |
           D_635467479_D_635467479_D_177539753==1 |
...
CURWORKT6 %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Days per Week Commuting to Previous Workplace")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
CURWORKT7 %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Same Type of Transportation on Commute Home (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
dt_CURWORKT8_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Time of Commute Home versus Commute to Work (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
dt_CURWORKT9_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Commuting Methods Home From Work (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
CURWORKT10A= Mod4 %>%   
  ...
  filter(D_203943120!=353358909 & D_404697804_D_404697804_D_581991828==1)
...
dt_CURWORKT10A_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Time Commuting Home in the Car (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
CURWORKT10B= Mod4 %>%   
  ...
  filter(D_203943120!=353358909 & D_404697804_D_404697804_D_846844103==1)
...
dt_CURWORKT10B_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Time Commuting Home in a Taxi (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
CURWORKT10C= Mod4 %>%  
  ...
  filter(D_203943120!=353358909 & D_404697804_D_404697804_D_660927579==1)
...
#   fmt_number(columns = "percentage", decimals = 2) %>% 
#   tab_header(title = md("Time Commuting Home in a Motorcycle (Previous Position)")) %>% 
#   cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
#   
#   tab_options(
#     stub.font.weight = "bold"
...
CURWORKT10D= Mod4 %>%   
  ...
  filter(D_203943120!=353358909 & D_404697804_D_404697804_D_940452831==1)
...
dt_CURWORKT10D_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Time Commuting Home on a Bus (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
CURWORKT10E= Mod4 %>%  
  ...
  filter(D_203943120!=353358909 & D_404697804_D_404697804_D_669359763==1)
...
dt_CURWORKT10E_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Time Commuting Home on a Subway (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
CURWORKT10F= Mod4 %>%   
  ...
  filter(D_203943120!=353358909 & D_404697804_D_404697804_D_950972496==1)
...
dt_CURWORKT10F_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Time Commuting Home on a Bike (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
CURWORKT10G= Mod4 %>%  
  ...
  filter(D_203943120!=353358909 & D_404697804_D_404697804_D_137216656==1)
...
dt_CURWORKT10F_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Time Commuting Home by Walking (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
#   filter(D_203943120!=353358909 & D_404697804_D_404697804_D_244488084==1)
...
CURWORKT11= CURWORKT11 %>%  mutate(Address1= case_when(is.na(D_186636914) ~"Skipped if it Includes Highways"))

dt_CURWORKT11_summary <- CURWORKT11 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_CURWORKT11_summary <- dt_CURWORKT11_summary[1,]

dt_CURWORKT11_summary[2,1] <- "Skipped if it Includes Major Roads" 
dt_CURWORKT11_summary[2,2] <- sum(is.na(CURWORKT11$D_936393993))
dt_CURWORKT11_summary[2,3] <- (sum(is.na(CURWORKT11$D_936393993))/dim(CURWORKT11)[[1]])*100

dt_CURWORKT11_summary[3,1] <- "Skipped if it Includes Local Roads" 
dt_CURWORKT11_summary[3,2] <- sum(is.na(CURWORKT11$D_168563469))
dt_CURWORKT11_summary[3,3] <- (sum(is.na(CURWORKT11$D_168563469))/dim(CURWORKT11)[[1]])*100

dt_CURWORKT11_summary <- dt_CURWORKT11_summary[c(2,3),]
dt_CURWORKT11_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Travel Commute Type (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
CURWORKT12_13= CURWORKT12_13 %>%  mutate(Address1= case_when(is.na(D_186636914) ~"Skipped if it Includes Highways"))

dt_CURWORKT12_13_summary <- CURWORKT12_13 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_CURWORKT12_13_summary <- dt_CURWORKT12_13_summary[1,]

dt_CURWORKT12_13_summary[2,1] <- "Skipped if it Includes Major Roads" 
dt_CURWORKT12_13_summary[2,2] <- sum(is.na(CURWORKT12_13$D_936393993))
dt_CURWORKT12_13_summary[2,3] <- (sum(is.na(CURWORKT12_13$D_936393993))/dim(CURWORKT12_13)[[1]])*100

dt_CURWORKT12_13_summary[3,1] <- "Skipped if it Includes Local Roads" 
dt_CURWORKT12_13_summary[3,2] <- sum(is.na(CURWORKT12_13$D_168563469))
dt_CURWORKT12_13_summary[3,3] <- (sum(is.na(CURWORKT12_13$D_168563469))/dim(CURWORKT12_13)[[1]])*100

dt_CURWORKT12_13_summary <- dt_CURWORKT12_13_summary[c(2,3),]
dt_CURWORKT12_13_summary %>%  gt::gt(rowname_col = "row_lab") %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Travel Commute Type (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
CURWORKT14= Mod4 %>%  filter(D_203943120==353358909  | is.na(D_581991828) |
...
dt_CURWORKT14_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Days per Week Commuting Home (Previous Position)")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
...
PREWORK= Mod4 %>%  filter(D_694113343!=353358909 & D_699873889!=353358909) %>% 
  mutate(Address1= case_when(is.na(D_995620555) ~"Skipped PREWORK"))
...
PREWORKRES= Mod4 %>%  filter(Mod4$D_995620555==353358909) %>%  
  mutate(Address1= case_when(is.na(D_980007418) ~"Skipped PREWORKRES"))
...
PREWORK1B= Mod4 %>%  filter(D_995620555==353358909 & D_980007418==104430631) %>%  
...
PREWORKT2A_H= Mod4 %>%   
  filter(D_311891586_D_311891586_D_172103427==1 |
           D_311891586_D_311891586_D_794959813==1 |
           D_311891586_D_311891586_D_683306241==1 |
           D_311891586_D_311891586_D_116442173==1 |
           D_311891586_D_311891586_D_639735881==1 | 
           D_311891586_D_311891586_D_296254034==1 |
           D_311891586_D_311891586_D_807973203==1 |
           D_311891586_D_311891586_D_766970054==1) %>%  
...
###[PREWORKT1=NR] OR [PREWORKT2A:H=0,1,2,3,4, or NR]-- second part is irrelevant, thats all the possible responses
PREWORKT3= Mod4 %>%   filter(!(D_311891586_D_311891586_D_172103427==1 |
                                 D_311891586_D_311891586_D_794959813==1 |
                                 D_311891586_D_311891586_D_683306241==1 |
                                 D_311891586_D_311891586_D_116442173==1 |
                                 D_311891586_D_311891586_D_639735881==1 | 
...
####################    NEED TO SWITCH OVER TO EDDIE'S FLATTEN BEFORE THIS CAN BE UPDATED. OTHERWISE WOULD NEED TO USE THE ENTITIY VARIABLE VERSIONS
...
PREWORKT8= Mod4 %>%   filter(is.na(D_251048648_D_251048648_D_197093427) & is.na(D_251048648_D_251048648_D_368973683) & 
                               is.na(D_251048648_D_251048648_D_450075248) & is.na(D_251048648_D_251048648_D_471142791) & 
                               is.na(D_251048648_D_251048648_D_572643998) & is.na(D_251048648_D_251048648_D_779421821) & 
                               is.na(D_251048648_D_251048648_D_830201925) & is.na(D_251048648_D_251048648_D_925663113)) %>%  
...
dt_CURSCHT1_summary[3,2] <- sum(is.na(CURSCHT1$D_404863614_D_404863614_D_638833327))
...
CURSCHT2A_H= STU %>% filter(D_404863614_D_404863614_D_782113721==1 |
                              D_404863614_D_404863614_D_207263450==1 |
                              D_404863614_D_404863614_D_638833327==1 |
                              D_404863614_D_404863614_D_736981982==1 |
                              D_404863614_D_404863614_D_932195315==1 |
                              D_404863614_D_404863614_D_279026426==1 |
                              D_404863614_D_404863614_D_691579493==1 |
                              D_404863614_D_404863614_D_211269389==1 ) %>%  
...
motorcycle <- CURSCHT2A_H %>% filter(D_404863614_D_404863614_D_638833327==1)
dt_CURSCHT2A_H_summary[3,2] <- sum(is.na(motorcycle$D_716117817_D_135529881_D_265423096))
dt_CURSCHT2A_H_summary[3,3] <- (sum(is.na(motorcycle$D_716117817_D_135529881_D_265423096))/dim(motorcycle)[[1]])*100
...
### [CURSCHT1 = NR] OR [CURSCHT2A:H=0, NR]
CURSCHT6= STU %>%  filter(!(D_404863614_D_404863614_D_782113721==1 |
                              D_404863614_D_404863614_D_207263450==1 |
                              D_404863614_D_404863614_D_638833327==1 |
                              D_404863614_D_404863614_D_736981982==1 |
                              D_404863614_D_404863614_D_932195315==1 |
...
#########   NEED TO FIX THE ENTITY ISSUE HERE
...
CURSCHT11= STU %>%  
  filter((D_219317801_D_990162153!=428999623 & !is.na(D_219317801_D_990162153)) |
...
dt_CURSCHT11_summary <- CURSCHT11 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_CURSCHT11_summary <- dt_CURSCHT11_summary[1,]

dt_CURSCHT11_summary[2,1] <- "Skipped if Includes Major Road(s)" 
dt_CURSCHT11_summary[2,2] <- sum(is.na(CURSCHT11$D_333852852))
dt_CURSCHT11_summary[2,3] <- (sum(is.na(CURSCHT11$D_333852852))/dim(dt_CURSCHT11_summary)[[1]])*100

dt_CURSCHT11_summary[3,1] <- "Skipped if Includes Local Road(s)" 
dt_CURSCHT11_summary[3,2] <- sum(is.na(CURSCHT11$D_776580384))
dt_CURSCHT11_summary[3,3] <- (sum(is.na(CURSCHT11$D_776580384))/dim(dt_CURSCHT11_summary)[[1]])*100

dt_CURSCHT11_summary <- dt_CURSCHT11_summary[c(2,3),]
dt_CURSCHT11_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
...
CURSCHT12_13= CURSCHT12_13 %>%   
  mutate(Address1= case_when(is.na(D_705673076) ~"Skipped if Includes Highway(s)"))

dt_CURSCHT12_13_summary <- CURSCHT12_13 %>% dplyr::group_by(Address1) %>%  dplyr::summarize(n=n(), percentage=100*n/nrow(.))  %>% dplyr::ungroup() %>%  dplyr::select(Address1, n, percentage)
dt_CURSCHT12_13_summary <- dt_CURSCHT12_13_summary[1,]

dt_CURSCHT12_13_summary[2,1] <- "Skipped if Includes Major Road(s)" 
dt_CURSCHT12_13_summary[2,2] <- sum(is.na(CURSCHT12_13$D_333852852))
dt_CURSCHT12_13_summary[2,3] <- (sum(is.na(CURSCHT12_13$D_333852852))/dim(dt_CURSCHT12_13_summary)[[1]])*100

dt_CURSCHT12_13_summary[3,1] <- "Skipped if Includes Local Road(s)" 
dt_CURSCHT12_13_summary[3,2] <- sum(is.na(CURSCHT12_13$D_776580384))
dt_CURSCHT12_13_summary[3,3] <- (sum(is.na(CURSCHT12_13$D_776580384))/dim(dt_CURSCHT12_13_summary)[[1]])*100

dt_CURSCHT12_13_summary <- dt_CURSCHT12_13_summary[c(2,3),]
dt_CURSCHT12_13_summary %>%  gt::gt() %>%  
  fmt_number(columns = "percentage", decimals = 2) %>% 
  tab_header(title = md("Road Type for School Commute Home")) %>% 
  cols_label(n= md("**Number of Participants**"),Address1 = md("**Question**"), percentage = md("**%**")) %>% 
  tab_options(
...
## CURSCHT8=1] OR [CURSCHT9=NR] OR [CURSCHT10A:H=0, NR]
CURSCHT14= STU %>% filter(D_230528407==353358909 |
                            !(D_345355061_D_345355061_D_467242967==1 |
                                D_345355061_D_345355061_D_645051966==1 |
                                #D_345355061_D_345355061_D_756061540==1 |
                                D_345355061_D_345355061_D_198883577==1 |
                                D_345355061_D_345355061_D_634680635==1 |
                                #D_345355061_D_345355061_D_790657437==1 |
                                D_345355061_D_345355061_D_107428524==1) |
                                #D_345355061_D_345355061_D_804918983==1) |
