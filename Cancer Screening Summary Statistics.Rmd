...
pt_pull <- "SELECT Connect_ID,  d_827220437, d_987563196, d_821247024, d_609630315
...
CSH_pull <- "SELECT * FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.cancerScreeningHistorySurvey` 
...
##9/11/25- displqy logic changed, removing requirement of sex organs to see certain responses. Desn'r affwct the ski plogic below
### Either participants answered selected a surgery, none, or skipped
...
one_logic_funct(D_590067228, D_729984625_D_630100221, 1, "Type of Oophorectomy")
  ...
  #age/year of surgery
ooph_a_sg=boxp_funct(D_787505819_D_623218391,"Age at Oophorectomy","Age") 
ooph_y_sg=boxp_funct(D_787505819_D_802622485,"Year of Oophorectomy","Year")
...
one_logic_funct(D_860839849, D_729984625_D_692881833, 1, "Type of Salpingectomy")
  ...
  #age/year
salp_a_sg=boxp_funct(D_949587133_D_623218391,"Age at Salpingectomy","Age") 
salp_y_sg=boxp_funct(D_949587133_D_802622485,"Year of Salpingectomy","Year")
grid.arrange(salp_a_sg, salp_y_sg, nrow=2)


#	Vasectomy 
vasec_a_sg=boxp_funct(D_671670265_D_623218391,"Age at Vasectomy","Age") 
vasec_y_sg=boxp_funct(D_671670265_D_802622485,"Year of Vasectomy","Year")
...
prost_y_sg=boxp_funct(D_343990595_D_802622485,"Year of Prostatectomy Surgery","Year") 
grid.arrange(prost_a_sg, prost_y_sg, nrow=2)


#	Penis removed (penectomy) 
penis_a_sg=boxp_funct(D_203366781_D_623218391,"Age at Penectomy Surgery","Age") 
penis_y_sg=boxp_funct(D_203366781_D_802622485,"Year of Penectomy Surgery","Year")
...
prost_grid= screen  %>% filter(D_890391968_D_700100953 == 1 | 
                                 (as.Date(d_609630315) > "2025-09-11" & D_729984625_D_733236542==1)) %>% 
mutate(
...
##OVSCREEN
OV_grid= screen  %>% 
  filter(D_890391968_D_434651539==1 |
           (as.Date(d_609630315) > "2025-09-11" & 
              (D_729984625_D_220755749==1 | D_729984625_D_630100221==1))) %>%   #9/11/25 prod update to skip logic
mutate(
...
CERV_grid= screen  %>% filter(D_890391968_D_505282171==1 |
           (as.Date(d_609630315) > "2025-09-11" & D_729984625_D_220755749==1)) %>%   #9/11/25 prod update to skip logic
mutate(
...
pivot_CERV %>%
    ...
    fmt_number(columns = "Percentage", decimals = 2) %>% 
    fmt_number(columns = "Frequency", decimals=0, use_seps = TRUE) %>%
    tab_header(title = md("Tests or Procedures for Cervical Cancer")) %>%
    cols_label(Frequency = md("**N**"), 
               Percentage = md("**%**"), 
               Procedures = md("**Answer**")) %>%
    tab_options(stub.font.weight = "bold") %>%
