...
# all_races <- c("D_384191091_D_384191091_D_178420302", "D_384191091_D_384191091_D_583826374", "D_384191091_D_384191091_D_636411467", "D_384191091_D_384191091_D_458435048",
#                "D_384191091_D_384191091_D_706998638", "D_384191091_D_384191091_D_973565052", "D_384191091_D_384191091_D_586825330","D_384191091_D_384191091_D_412790539", 
#                "D_384191091_D_384191091_D_807835037", "D_384191091_D_747350323", "D_384191091_D_384191091_D_746038746")
# 
# 
# which_race <- module1 %>%
#   rowwise() %>%
#   mutate(
#     num_race_responses = sum(c_across(all_of(all_races)) %>% as.numeric(), na.rm = TRUE),
#     multi_racial = ifelse(num_race_responses > 1, 1, 0)
#   ) %>%
#   ungroup()
# 
# 
...
#   group_by(Connect_ID) %>%
#   mutate(
#     num_race_responses = sum(all_of(all_races=="1"), na.rm = TRUE),
#     multi_racial = ifelse(num_race_responses > 1, 1, 0)
#   ) %>%
#   ungroup()
...
for (i in 1:length(module1$Connect_ID)){
  AI=ifelse((module1$D_384191091_D_384191091_D_583826374[[i]]=='1' & (module1$D_384191091_D_384191091_D_636411467[[i]]=='1' | module1$D_384191091_D_384191091_D_458435048[[i]]=='1'|
                                               ...
                                               module1$D_384191091_D_384191091_D_807835037[[i]]=='1' | module1$D_384191091_D_384191091_D_178420302[[i]]=='1')), 1, 0)
  ...
  Ot=ifelse((module1$D_384191091_D_384191091_D_807835037[[i]]=='1' & (module1$D_384191091_D_384191091_D_583826374[[i]]=='1' | module1$D_384191091_D_384191091_D_636411467[[i]]=='1'|
                                                        module1$D_384191091_D_384191091_D_458435048[[i]]=='1' | module1$D_384191091_D_384191091_D_706998638[[i]]=='1' |
                                                        module1$D_384191091_D_384191091_D_586825330[[i]]=='1' | module1$D_384191091_D_384191091_D_973565052[[i]]=='1' |
                                                        module1$D_384191091_D_384191091_D_412790539[[i]]=='1' | module1$D_384191091_D_384191091_D_178420302[[i]]=='1')), 1, 0)
  Uk=ifelse((module1$D_384191091_D_384191091_D_178420302[[i]]=='1' & (module1$D_384191091_D_384191091_D_583826374[[i]]=='1' | module1$D_384191091_D_384191091_D_458435048[[i]]=='1'|
                                                        module1$D_384191091_D_384191091_D_706998638[[i]]=='1' | module1$D_384191091_D_384191091_D_973565052[[i]]=='1' |
                                                        module1$D_384191091_D_384191091_D_586825330[[i]]=='1' | module1$D_384191091_D_384191091_D_412790539[[i]]=='1' |
                                                        module1$D_384191091_D_384191091_D_807835037[[i]]=='1' | module1$D_384191091_D_384191091_D_636411467[[i]]=='1')), 1, 0)
  multi_race= multi_race + sum(AI+As+Bl+Hs+Me+Hw+Wh+Ot+Uk, na.rm=T)

}

  

module1$multi_racial <- c(rep(1, times=multi_race), rep(0, times=(dim(module1)[1]- multi_race)))



## RACE

which_race= module1 %>%  mutate(race= case_when(multi_racial==1 ~ "Multi-Racial",
...
\FloatBarrier
## Children
```{r Children1, warning=FALSE, echo=FALSE, message=FALSE}
##Children 
...
```{r Children2, warning=FALSE, echo=FALSE, message=FALSE}

### This table was sinking into the next section of the report for some reason. Had to make it its own section
...
```{r Children3, warning=FALSE, echo=FALSE, message=FALSE}
