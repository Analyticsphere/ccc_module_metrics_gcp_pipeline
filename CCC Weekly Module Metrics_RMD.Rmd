...
bio_bqpull <-"SELECT Connect_ID, min(d_556788178) as d_556788178 FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.biospecimen_JP` 
...
trig_csh <- bq_project_query(project,
                             query="SELECT distinct(Connect_ID), notification_time as CSH_notif FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.notifications_JP` notif
                             ...
                             #query="SELECT distinct(token), notification_time FROM `nih-nci-dceg-connect-dev.FlatConnect.notifications_JP` where category LIKE '%Screen%' and attempt='1st contact'")
...
queries <- list(
  ...
  CSH_lang_c = "SELECT pts.Connect_ID, csh.d_784119588, d_255077064
                FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.cancerScreeningHistorySurvey_JP` csh
                left join `nih-nci-dceg-connect-prod-6d04.FlatConnect.participants_JP` pts
