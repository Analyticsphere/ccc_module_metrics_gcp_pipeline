...
parts <- "SELECT Connect_ID, d_564964481, d_795827569, d_544150384, d_117249500, d_454445267,d_949302066 FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.participants_JP` where Connect_ID IS NOT NULL and 
d_821247024='197316935' and d_747006172!='353358909' and d_831041022!='353358909' and
DATE(d_914594314) < '2024-07-02'" 
...
and DATE(d_914594314) < '2024-07-02'" 
...
cat("Data includes enrollment through 2024-07-01")
